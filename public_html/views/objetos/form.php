...
<div class="max-w-3xl mx-auto">
    <h2 class="text-3xl font-bold text-gray-800 mb-6"><?php echo $isEdit ? 'Editar' : 'Novo'; ?> Objeto</h2>
    ...
    <form method="POST" class="bg-white rounded-lg shadow-md p-6 space-y-4">
        ...
        <div>
            ...
            <textarea name="objeto" rows="4"
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-slate-500"><?php echo htmlspecialchars($item['objeto'] ?? ''); ?></textarea>
        </div>

        <div class="flex gap-4 pt-4">
            <button type="submit" 
                    onclick="return confirmAction(event, 'Deseja salvar este objeto?', 'question', 'Sim, salvar!', '#1e293b')"
